...
import { Archive, BarChart2, BookOpen, Book, NotebookText, CheckSquare, Bot, Calendar, Save, Download, Lightbulb } from 'lucide-react';
    ...
    <div className="p-6 space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
          <Archive className="w-6 h-6" /> Backup & Export
        </h1>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm">
        <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-4 flex items-center gap-2">
          <BarChart2 className="w-5 h-5 text-blue-500" /> Resumen de datos
        </h2>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <StatItem icon={<BookOpen className="w-6 h-6 text-blue-500 mx-auto" />} label="Semestres" value={stats.semesters} />
          <StatItem icon={<Book className="w-6 h-6 text-blue-400 mx-auto" />} label="Materias" value={stats.subjects} />
          <StatItem icon={<NotebookText className="w-6 h-6 text-green-500 mx-auto" />} label="Notas" value={stats.notes} />
          <StatItem icon={<CheckSquare className="w-6 h-6 text-orange-500 mx-auto" />} label="Tareas" value={stats.tasks} />
          <StatItem icon={<Bot className="w-6 h-6 text-purple-500 mx-auto" />} label="Prompts" value={stats.prompts} />
        </div>
      </div>
